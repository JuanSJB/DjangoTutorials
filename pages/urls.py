...
from .views import HomePageView, AboutPageView, ContactPageView, ProductIndexView, ProductCreateView ,ProductShowView, CartView, CartRemoveAllView, ImageViewFactory, ImageLocalStorage, ImageViewNoDI
urlpatterns = [
